                            ...
                            ->arrayNode( 'options' )
                                ->children()
                                        ...
                                        ->arrayNode( 'available_champions' )
                                            ->prototype('scalar')->end()
                                        ->end( )
                                        ->booleanNode('can_have_alchemist')->defaultTrue()->end( )
                                        ->booleanNode('can_have_sorcerer')->defaultTrue()->end( )
                                        ->booleanNode('can_have_igor')->defaultFalse()->end( )
                                        ->booleanNode('can_have_halfing_kitchener')->defaultFalse()->end( )
                                ->end( )
                            ->end( )
                        ->end( )
                    ->end( )
