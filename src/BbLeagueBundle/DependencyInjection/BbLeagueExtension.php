...
namespace BbLeagueBundle\DependencyInjection;
...
use BbLeagueBundle\DependencyInjection\Configuration;

class BbLeagueExtension extends Extension implements PrependExtensionInterface
{
    /**
     * {@inheritDoc}
     */
    ...
    public function load(array $configs, ContainerBuilder $container)
    {
        ...
        $container->setParameter('bb_league.rules', $config['rules']);
